        ...
        {detail ? <div className="marketing-entity-detail marketing-database-workspace print-area">
          ...
          {canArchive ? <section className="marketing-archive-panel">
            ...
            <div className="marketing-database-results-actions">
              <div><h3>نتائج النشر والتفاعل</h3><p>Facebook وInstagram وTikTok وSnapchat وYouTube من نفس مصدر نتائج النشر والتفاعل.</p></div>
            ...
            <EngagementResultDetail result={detail.engagementResults} platforms={MARKETING_RESULT_PLATFORMS} />
          </section>}
        </div> : null}
      </Modal>
