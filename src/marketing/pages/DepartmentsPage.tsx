...
export function DepartmentsPage({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  const content = <>
    ...
    <div className="marketing-settings-grid">
      <section className="marketing-card">
        ...
        <p className="marketing-picker-empty">تعيين المستخدمين داخل الأقسام يتم فقط من الإعدادات ← المستخدمون والصلاحيات ← المستخدمون ← التسويق ← الأقسام المسموحة.</p>
  ...
  return <MarketingPage title="الأقسام" description="إدارة تعريفات الأقسام وإجراءات التكليف والكرييتيفات وأنواع الحملات والمنصات. تعيين المستخدمين يتم من المستخدمون والصلاحيات.">{content}</MarketingPage>;
}
