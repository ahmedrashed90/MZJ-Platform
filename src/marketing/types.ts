...
export type PlatformPostType = { id: string; platform_id: string; name: string; width?: number | null; height?: number | null; publish_format?: "story" | "reel" | "short" | "photo_post" | "carousel" | "video" | "post" | null };
