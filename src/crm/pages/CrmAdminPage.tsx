          ...
          <section className="crm-panel crm-form-panel crm-distribution-editor">
            ...
            <div className="crm-distribution-section">
              ...
              <div className="crm-form-grid crm-form-grid-wide">
                ...
                {ruleForm.assignmentMode === "percentage" ? <div className="crm-field-wide crm-percentage-mode-note"><strong>التوزيع بالنسبة المئوية</strong><span>اكتب نسبة كل مندوب من 0 إلى 100. نسبة 0% تبقي المندوب داخل القاعدة بدون استقبال عملاء، ويجب أن يكون مجموع نسب المناديب المؤهلين داخل كل فرع 100%.</span></div> : null}
              </div>
            </div>
