  ...
  return (
    <div className="crm-entry-routing-settings">
      ...
      <section className="crm-panel crm-entry-routing-overview">
        <header><div><h2>منطق دخول وتوزيع العملاء</h2><p>هذه الصفحة توضح حدود كل محرك فقط. تعديل نصوص رسائل وردود العميل يتم من إعدادات الأوتوميشن، وتعديل الموظفين وترتيب الدور يتم من توزيع العملاء.</p></div><button className="crm-secondary-button" onClick={() => void load()}><ArrowClockwise size={17} />{loading ? "جاري التحميل" : "تحديث الحالة"}</button></header>
      ...
      <div className="crm-settings-grid crm-entry-routing-grid">
        <section className="crm-panel settings-card">
          <header><div><h2>إعدادات الأوتوميشن</h2><p>المصدر الوحيد لتعديل نصوص الرسائل والردود المقبولة داخل الفلو الثابت.</p></div></header>
