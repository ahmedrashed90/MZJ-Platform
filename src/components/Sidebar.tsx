...
export function Sidebar() {
  ...
  const canViewMarketing = isAdmin || Boolean(user?.departmentCodes.includes("marketing")) || Boolean(user?.permissions.some((permission) => permission.startsWith("marketing.")));
