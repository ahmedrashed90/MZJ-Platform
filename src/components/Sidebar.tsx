...
export function Sidebar() {
  ...
  const canViewMarketing = isAdmin || Boolean(user?.permissions.includes("marketing.view")) || Boolean(user?.departmentCodes.some((code) => ["marketing", "content", "design", "montage", "photography"].includes(code))) || Boolean(user?.roleCodes.includes("marketing_user"));
