-- MZJ native marketing rebuild migration
-- Generated 2026-07-23; safe to run repeatedly.
...
insert into marketing.attendance_settings(id) values('default') on conflict(id) do nothing;
...
-- Operations-side audit for the shared photography request record
