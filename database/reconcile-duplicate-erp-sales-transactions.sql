...
SET
  ...
  sale_at=case when coalesce(st.metadata->>'soldDateOverride','false')='true' then st.sale_at else coalesce((r.order_date::timestamp AT TIME ZONE 'Asia/Riyadh'),st.sale_at) end,
