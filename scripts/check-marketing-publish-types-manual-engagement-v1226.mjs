...
const checks = [
  ...
  ["Instagram photo post cannot silently become a Reel", publishApi.includes("بوست Instagram يقبل الصور فقط. اختر Reel لنشر الفيديو")],
  ...
  ["manual publishing is standalone and selects a system creative type", !publishPage.includes("manualSources") && !publishPage.includes("sourceKey") && publishPage.includes("اختر نوع الكرييتيف من قائمة الكرييتيفات") && publishPage.includes("meta?.creativeTypes")],
