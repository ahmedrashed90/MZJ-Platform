...
if (packageJson.version !== "1.16.8") throw new Error("Tracking deleted release check failed: package version must be 1.16.8");
...
console.log("Tracking deleted-order release v1.16.8 check passed.");
