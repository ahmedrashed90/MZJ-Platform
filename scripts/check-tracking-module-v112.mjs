...
const checks = [
  ...
  ["server/_tracking-schema.ts", "tracking_orders_source_key_unique_idx"],
  ...
  ["src/tracking/pages/TrackingOrdersPage.tsx", "createPortal"],
  ["server/tracking/delete.ts", "tracking.orders.delete"],
  ["server/tracking/delete.ts", "vehiclesRemainInOperations"],
...
console.log("Tracking native platform module, archive flow, public page, source-identity deletion, dual-sync ingest, and SMS+ checks passed.");
