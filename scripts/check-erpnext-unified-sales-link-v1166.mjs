...
if (packageJson.version !== "1.16.7") throw new Error("ERPNext unified link check failed: package version must be 1.16.7");
...
console.log("ERPNext unified Sales Order -> Tracking + CRM + Operations v1.16.7 check passed.");
