...
requireText("server/crm/manual-leads.ts", "const assignedTo = clean(row.requested_assigned_to) || clean(row.requested_by)", "Manual edit must preserve the salesperson who owns the manual lead");
