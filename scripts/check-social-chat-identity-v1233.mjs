...
const checks = [
  ...
  ['social comment keeps comment id and messaging state', engagement.includes('commentId: commentId || null') && engagement.includes('item.platform === "instagram" ? "private_reply_available" : "identity_pending"')],
  ...
  ['Facebook social lead cannot silently send with a fake PSID', messaging.includes('لم يبدأ محادثة Messenger بعد') && messaging.includes('لم يصبح جاهزًا للمراسلة بعد')],
