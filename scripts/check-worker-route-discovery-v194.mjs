...
const checks = [
  ['WhatsApp uses only the configured canonical worker route', messaging.includes('endpoint.text_send_url || endpoint.send_url') && !messaging.includes('/outbound/whatsapp/v1/') && !messaging.includes('/send/whatsapp')],
  ...
  ['Admin exposes one WhatsApp send field for text, templates, and media', admin.includes('مسار إرسال النص والقوالب') && admin.includes('الصور والصوت والفيديو والملفات تستخدم مسار واتساب الواحد') && !admin.includes('مسار إرسال الوسائط')],
];
