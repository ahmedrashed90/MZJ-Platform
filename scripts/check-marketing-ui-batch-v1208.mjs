...
check('budget display uses the professional canonical overview and budget manager', database.includes('marketing-budget-overview') && database.includes('marketing-budget-manage-button') && database.includes('إجمالي الميزانية كاملة') && database.includes('budgetGrandTotal'));
