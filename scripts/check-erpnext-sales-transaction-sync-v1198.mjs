...
expect('same sales order reuses any active prior row and merges duplicates', sync.includes('where source_reference=${normalized.orderNo}') && sync.includes("mergedReason: 'erpnext_sales_order_deduplication'"));
