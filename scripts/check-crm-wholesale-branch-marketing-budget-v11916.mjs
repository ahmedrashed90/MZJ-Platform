...
check("department report groups by the same canonical department and branch", reports.includes("departmentBranchDepartmentCode(row.department_code, row.branch_code)") && reports.includes("departmentBranchDepartmentCode(fact.department_code, fact.branch_code)") && reports.includes("const departmentContext = new Map"));
