...
const checks = [
  ...
  [settings.includes("unified-settings-section-grid") && settings.includes("إغلاق القسم") && settings.includes("ابحث عن إعداد أو نظام"), "Settings workspace navigation/search/collapse must remain present"],
