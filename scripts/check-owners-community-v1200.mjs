...
expect("admin membership preview reuses the exact customer discount calculator", memberPreview.includes("OwnersDiscountCalculator") && portal.includes("OwnersDiscountCalculator") && discountCalculator.includes("احسب خصمك") && discountCalculator.includes("priceBeforeTax") && discountCalculator.includes("* 0.01") && discountCalculator.includes("Math.floor((rawDiscount + 1e-9) / 100) * 100") && discountCalculator.includes("ابحث عن السيارة") && adminApi.includes("websiteCarsForDiscountCalculator") && adminApi.includes("getWebsiteStock") && adminApi.includes("websiteCars: websiteCars.cars"));
