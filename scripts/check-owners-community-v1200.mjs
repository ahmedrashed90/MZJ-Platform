...
expect("public and admin member pages use the dynamic points menu and movement ledger", portal.includes("pointsMenu.repurchase") && memberPreview.includes("pointsMenu.repurchase") && portal.includes("سجل الحركة") && memberPreview.includes("سجل الحركة") && portal.includes("عدد النقاط") && memberPreview.includes("عدد النقاط"));
