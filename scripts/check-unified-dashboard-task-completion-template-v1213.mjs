...
const checks = [
  ...
  ["upload preview uses the same Task Template design", taskModal.includes('mode="preview"') && taskModal.includes("marketing-template-preview-design") && !taskModal.includes("marketing-template-preview-table")],
