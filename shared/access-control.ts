...
export const PAGE_CATALOG: CatalogPage[] = [
  ...
  { system: "crm", code: "finance_history", name: "سجل العملاء", route: "/crm/finance-history", sortOrder: 40 },
  ...
  { system: "marketing", code: "engagement", name: "تفاعل النشر", route: "/marketing/engagement", sortOrder: 75 },
  ...
  { system: "operations", code: "sales_orders_followup", name: "متابعة طلبات البيع", route: "/operations/sales-orders", sortOrder: 55 },
...
export const PERMISSION_CATALOG: CatalogPermission[] = [
  ...
  p("crm.finance_history.view", "مشاهدة سجل العملاء", "crm", "finance_history", "view", "page"),
  ...
  p("operations.sales_orders_followup.view", "مشاهدة متابعة طلبات البيع", "operations", "sales_orders_followup", "view", "page"),
  ...
  p("marketing.engagement.view", "مشاهدة تفاعل النشر", "marketing", "engagement", "view", "page"),
  p("marketing.engagement.subscribe", "تفعيل استقبال التفاعلات", "marketing", "engagement", "subscribe", "action", "تفعيل اشتراكات استقبال التفاعلات", true),
  p("marketing.engagement.status.view", "مشاهدة حالة استقبال التفاعلات", "marketing", "engagement", "status_view", "action"),
  p("marketing.engagement.webhook.view", "مشاهدة رابط Webhook للتفاعلات", "marketing", "engagement", "webhook_view", "action", "عرض ونسخ رابط Webhook الخاص بالتفاعلات", true),
  p("marketing.engagement.refresh", "تحديث أرقام التفاعلات", "marketing", "engagement", "refresh", "action", "جلب أحدث أرقام المنشورات والتفاعلات", true),
