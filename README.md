...
- إضافة يوم العطلة الأسبوعية لكل User داخل تعيين جدول العمل نفسه.
- يوم العطلة لا يتحسب غيابًا ويظهر في التقرير باسم «عطلة».
- الحفاظ على الفترات العابرة لمنتصف الليل حسب يوم العمل الأصلي.
- إصلاح خطأ TypeScript `TS2345` في صفحة الحضور الذي منع نشر V74 على Vercel.
- النسخة كاملة ونظيفة بدون Patch على Patch.

راجع `DELIVERY-GLOBAL-ATTENDANCE-CLEAN-V75.md`.
