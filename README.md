...
## v1.19.5 — تنظيف الأدوار وحذف الحسابات

- إزالة التكرار من عرض **الأدوار العامة** مع الحفاظ على تعيينات المستخدمين الحالية.
- تثبيت الفصل بين دور **مدير الحسابات** ودور **مدير المالية**.
- إضافة حذف آمن للحساب من تبويب المستخدمين والصلاحيات، مع سبب إلزامي وكتابة اسم المستخدم للتأكيد.
- إبطال جلسات الحساب المحذوف وإزالة بيانات دخوله وإخفاؤه من القائمة، مع الاحتفاظ بالسجلات التشغيلية وسجل التدقيق.
- منع حذف الحساب الحالي ومنع حذف آخر مدير نظام فعال.

راجع `docs/CENTRAL-ACCESS-USERS-V1195-AR.md`.
...
- 216 مفتاح صلاحية، و37 صفحة، و12 نطاق بيانات، مع Migration وSeed وRollback وتقارير مراجعة واختبارات.
