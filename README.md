...
- إذا كان للمستخدم مكان حضور مطلوب، يتم طلب GPS وحفظ الإحداثيات والدقة والمسافة ونتيجة المطابقة في سجل الحضور.
- تقرير الحضور يعرض وقت الحضور والانصراف ومكان الحضور الفعلي والمكان المطلوب والنتيجة، مع إعادة تصميم الجدول بشكل أوضح وأكثر احترافية.
- إضافة زر واضح لكل مستخدم: **تسجيل انصراف وتسجيل خروج**؛ يغلق فترة الحضور المفتوحة أولًا ثم ينهي جلسة المنصة.
- الحفاظ على الوضع الآمن من V77: منع الدخول والـForced Logout والـCron يظلون متوقفين حتى يفعّل مدير النظام «تطبيق الحضور على تسجيل الدخول».
- الحفاظ على baseline إصدار الحزمة `1.19.16` حتى تظل فحوص Marketing Packages + MZJ Club ناجحة.
- النسخة كاملة ونظيفة مبنية مباشرة من V77 بدون Patch على Patch.

راجع `DELIVERY-GLOBAL-ATTENDANCE-CLEAN-V78.md`.
