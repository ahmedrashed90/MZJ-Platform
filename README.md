# MZJ Platform — تسليم v1.21.0 من السورس النظيف

> مصدر التنفيذ المباشر: `MZJ-v1.20.0-MARKETING-CONTENT-USERS-CLEAN-FULL`. لم تُستخدم نسخ v1.20.1–v1.20.8 كأساس أو كمصدر ملفات.

تشمل هذه النسخة إعادة تنظيم ميزانية وجدول نشر إنشاء الحملة، وإعادة تنظيم إنشاء الأجندة واختيار السيارات، والنقل اليدوي عند 100% إلى قسم النشر، وإعدادات تصنيفات/مبيعات الباقات، وتصدير PDF للباقات فقط.

راجع `docs/MARKETING-CLEAN-ROOT-REBUILD-V1210-AR.md`.
