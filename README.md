...
## v1.19.9 — إصلاح أقسام التسويق وقوالب الأدوار

- إصلاح تعارض `departments_name_key` في إعدادات سيستم التسويق.
- إعادة استخدام القسم المركزي الموجود ومزامنة نفس UUID في التسويق والمستخدمين والصلاحيات.
- إصلاح تلقائي وآمن لأقسام التسويق القديمة ذات الأسماء والمعرّفات المتعارضة.
- عرض قالب دور واحد لكل اسم متكرر دون حذف أو دمج سجلات الأدوار ودون تعديل `role_id`.
- التنفيذ مبني مباشرة على السورس النظيف v1.19.7.

راجع `docs/MARKETING-DEPARTMENTS-ROLES-FIX-V1199-AR.md`.
