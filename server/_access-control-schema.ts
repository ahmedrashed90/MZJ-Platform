...
('crm','finance_history','سجل العملاء','/crm/finance-history',40,true),
...
('crm.finance_history.view','مشاهدة سجل العملاء','crm','finance_history','view','مشاهدة سجل العملاء','مشاهدة سجل العملاء','page',false,290,true),
...
('operations.sales_orders_followup.view','مشاهدة متابعة طلبات البيع','operations','sales_orders_followup','view','مشاهدة متابعة طلبات البيع','مشاهدة صفحة متابعة طلبات البيع المرتبطة بالتراكينج والموافقات','page',false,865,true),
...
('marketing.engagement.view','مشاهدة تفاعل النشر','marketing','engagement','view','مشاهدة تفاعل النشر','مشاهدة صفحة تفاعل النشر','page',false,1501,true),
('marketing.engagement.subscribe','تفعيل استقبال التفاعلات','marketing','engagement','subscribe','تفعيل استقبال التفاعلات','تفعيل اشتراكات استقبال التفاعلات','action',true,1502,true),
('marketing.engagement.status.view','مشاهدة حالة استقبال التفاعلات','marketing','engagement','status_view','مشاهدة حالة استقبال التفاعلات','عرض حالة اشتراكات استقبال التفاعلات','action',false,1503,true),
('marketing.engagement.webhook.view','مشاهدة رابط Webhook للتفاعلات','marketing','engagement','webhook_view','مشاهدة رابط Webhook للتفاعلات','عرض ونسخ رابط Webhook الخاص بالتفاعلات','action',true,1504,true),
('marketing.engagement.refresh','تحديث أرقام التفاعلات','marketing','engagement','refresh','تحديث أرقام التفاعلات','جلب أحدث أرقام المنشورات والتفاعلات','action',true,1505,true),
...
insert into core.role_permissions(role_id,permission_id)
select r.id,p.id from core.roles r join core.permissions p on p.code in ('marketing.agenda.create','marketing.agenda.delete','marketing.agenda.edit','marketing.assignment_action.admin','marketing.assignment_action.execute','marketing.assignment_actions.approve','marketing.calendar.view','marketing.campaign.archive','marketing.campaign.create','marketing.campaign.delete','marketing.campaign.edit','marketing.connections.manage','marketing.create_agenda.view','marketing.create_campaign.view','marketing.dashboard.view','marketing.database.view','marketing.file.delete','marketing.file.download','marketing.file.upload','marketing.file.view_others','marketing.monitoring.view','marketing.packages.view','marketing.photo_request.complete','marketing.photo_request.create','marketing.platforms.view','marketing.publish.now','marketing.publish_prep.manage','marketing.publish_prep.view','marketing.engagement.view','marketing.engagement.subscribe','marketing.engagement.status.view','marketing.engagement.webhook.view','marketing.engagement.refresh','marketing.receipt_calendar.view','settings.marketing.manage','settings.marketing.view','marketing.stock.view','marketing.structure.approve','marketing.structure.reject','marketing.task.final_file.upload','marketing.task.receive','marketing.task.reopen','marketing.task.view_all','marketing.task.view_assigned','marketing.task_template.approve','marketing.task_template.download','marketing.task_template.reject','marketing.task_template.reupload','marketing.task_template.upload','marketing.task_template.view_feedback','system.marketing.access') where r.code='marketing_admin'
on conflict do nothing;

insert into core.role_permissions(role_id,permission_id)
select r.id,p.id from core.roles r join core.permissions p on p.code in ('marketing.assignment_action.execute','marketing.calendar.view','marketing.dashboard.view','marketing.database.view','marketing.file.download','marketing.file.upload','marketing.photo_request.complete','marketing.receipt_calendar.view','marketing.stock.view','marketing.task.final_file.upload','marketing.task.receive','marketing.task.view_assigned','marketing.task_template.download','marketing.task_template.reupload','marketing.task_template.upload','marketing.task_template.view_feedback','system.marketing.access') where r.code='marketing_user'
on conflict do nothing;

insert into core.role_permissions(role_id,permission_id)
select r.id,p.id from core.roles r join core.permissions p on p.code in ('operations.all.view','operations.approval.administrative','operations.approval.financial','operations.approvals.view','operations.archive.view','operations.inventory.view','operations.sales_orders_followup.view','operations.manage.view','operations.movement.create','operations.movement.delivered','operations.movement.export','operations.movement.view','operations.movements.view','operations.request.finish_order','operations.request.receive_car','operations.request.receive_order','operations.request.rollback','operations.request.send_car','operations.request.skip','settings.operations.manage','settings.operations.view','operations.transfer.attachment.manage','operations.transfer.cancel','operations.transfer.create','operations.transfer.delete','operations.transfer.edit','operations.transfer.export','operations.transfer.note.add','operations.transfer.print','operations.transfer.reopen','operations.transfer.send','operations.transfers.view','operations.vehicle.archive','operations.vehicle.checklist.update','operations.vehicle.create','operations.vehicle.delete','operations.vehicle.edit','operations.vehicle.export','operations.vehicle.import','operations.vehicle.location.update','operations.vehicle.notes.update','operations.vehicle.restore','operations.vehicle.status.update','operations.vehicle.template.download','operations.vehicle.view','system.operations.access') where r.code='operations_manager'
on conflict do nothing;

insert into core.role_permissions(role_id,permission_id)
select r.id,p.id from core.roles r join core.permissions p on p.code in ('operations.inventory.view','operations.sales_orders_followup.view','operations.manage.view','operations.movement.create','operations.movement.export','operations.movement.view','operations.movements.view','operations.request.finish_order','operations.request.receive_car','operations.request.receive_order','operations.request.send_car','operations.transfer.attachment.manage','operations.transfer.create','operations.transfer.edit','operations.transfer.export','operations.transfer.note.add','operations.transfer.print','operations.transfer.send','operations.transfers.view','operations.vehicle.checklist.update','operations.vehicle.create','operations.vehicle.edit','operations.vehicle.export','operations.vehicle.import','operations.vehicle.location.update','operations.vehicle.notes.update','operations.vehicle.status.update','operations.vehicle.template.download','operations.vehicle.view','system.operations.access') where r.code='operations_admin'
on conflict do nothing;
...
insert into core.role_permissions(role_id,permission_id)
select r.id,p.id from core.roles r join core.permissions p on p.code in ('operations.approval.financial','operations.approvals.view','operations.inventory.view','operations.sales_orders_followup.view','operations.vehicle.view','system.operations.access') where r.code='finance_manager'
on conflict do nothing;

insert into core.role_permissions(role_id,permission_id)
select r.id,p.id from core.roles r join core.permissions p on p.code in ('operations.approval.financial','operations.approvals.view','operations.inventory.view','operations.sales_orders_followup.view','operations.movement.export','operations.vehicle.view','system.operations.access','system.tracking.access','tracking.order.open','tracking.order.search','tracking.orders.view') where r.code='accounts_manager'
on conflict do nothing;
...
const MERSAL_USER_LINK_SQL = String.raw`
begin;
...
async function mersalUserLinkSchemaReady() {
  const sql = getSql();
  const [state] = await sql<{ ready: boolean }[]>`
    select
      exists(
        select 1 from information_schema.columns
        where table_schema='core' and table_name='users' and column_name='mersal_user_id'
      )
      and exists(
        select 1 from information_schema.tables
        where table_schema='core' and table_name='mersal_users'
      )
      as ready
  `;
...
async function ensureMersalUserLinkSchema() {
  if (await mersalUserLinkSchemaReady()) return;
  await withDatabaseAdvisoryLock(
    'mzj:access-control-mersal-user-link:v1',
    async () => {
      if (await mersalUserLinkSchemaReady()) return;
      await runSqlScript(MERSAL_USER_LINK_SQL);
      if (!(await mersalUserLinkSchemaReady())) {
        throw new Error('ACCESS_CONTROL_MERSAL_USER_LINK_SCHEMA_NOT_READY');
      }
    },
  );
}
...
export function ensureAccessControlSchema() {
  if (!accessControlSchemaPromise) {
    accessControlSchemaPromise = (async () => {
      ...
      await ensureMersalUserLinkSchema();
