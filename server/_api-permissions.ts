...
function marketingRequirement(request: VercelRequest): ApiPermissionRequirement {
  ...
  const map: Record<string, string> = {
    ...
    attach_final_file: "marketing.task.final_file.upload", prepare_final_upload: "marketing.task.final_file.upload", confirm_final_upload: "marketing.task.final_file.upload", cancel_final_upload: "marketing.task.final_file.upload", attach_final_media_group: "marketing.task.final_file.upload",
    move_to_publishing: "system.marketing.access", save_publish_prep: "marketing.publish_prep.manage", publish_now: "marketing.publish.now", save_result_file: "marketing.file.upload",
